...
interface DownloadService {
    ...
    companion object {
        ...
        fun createService() =    Retrofit.Builder().client(client).baseUrl("https://raw.githubusercontent.com").addCallAdapterFactory(RxJavaCallAdapterFactory).build().create(DownloadService::class.java)
