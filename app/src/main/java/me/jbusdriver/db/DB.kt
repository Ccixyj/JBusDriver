...
object DB {
    ...
    private val dataBase by lazy {
        val configuration = SupportSQLiteOpenHelper.Configuration.builder(appContext)
    ...
    private val collectDataBase by lazy {
        val configuration = SupportSQLiteOpenHelper.Configuration.builder(object : SDCardDatabaseContext(appContext) {
            override val dir: String = appContext.packageName + File.separator + "collect"
