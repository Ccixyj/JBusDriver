...
object CacheLoader {
    ...
    private fun initMemCache(): LruCache<String, String> {
        ...
        val myActivityManager = appContext.getSystemService(Activity.ACTIVITY_SERVICE) as ActivityManager
        ...
        if (memoryInfo.lowMemory) {
            MobclickAgent.reportError(appContext, "可能的内存不足")
            appContext.toast("当前可用内存:$memSize,请注意释放内存")
        }
