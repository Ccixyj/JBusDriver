...
interface IMagnetLoader {
    ...
    companion object {
        ...
        val MagnetLoaders: Map<String, IMagnetLoader> by lazy {
            mapOf("BTDB" to BTDBMagnetLoaderImpl(), "btdigg" to BtdiggsMagnetLoaderImpl(), "BTSO.PW" to BtsoPWMagnetLoaderImpl(), "TorrentKitty" to TorrentKittyMangetLoaderImpl(), "BTSOW" to BTSOWMagnetLoaderImpl(), "Kitty" to CNBtkittyMangetLoaderImpl(), "Btanv" to BtanvMagnetLoaderImpl())
        }
    }
